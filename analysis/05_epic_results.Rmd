...
lmm_pred <- function(train_data,
  ...
  fitting <-  lme(ht ~ bs(time, knots = c(10, 12, 15), degree = 2) * sex - 1,
                  random = ~ 1 + bs(time, degree = 1, intercept = FALSE)| id,
                  control = ctrl,
                  data = train_data)
...
print("4. linear brokenstick works-------------------------- finished")
...
save(seed,
     ...
     lmm_train,
     lmm_test,
     file = "randy_result_20221201_14.Rdata")
```
