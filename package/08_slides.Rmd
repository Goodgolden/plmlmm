...
```{r "Example trajectories for sample matching", out.width='40%', fig.cap="Individual matching trajectoreis example",fig.show='hold',fig.align='center'}
knitr::include_graphics(c('figure/fig01.png', 'figure/fig02.png'))
```
...
## Large Simulation Study with 1000 datasets

Bias

```{r out.width='100%', fig.align='center'}
knitr::include_graphics("test_bias_simulation_20221020.png")
```
...
```{r out.width='100%', fig.align='center'}
knitr::include_graphics("test_rmse_simulation_20221020.png")
```
...
```{r out.width='100%', fig.align='center'}
knitr::include_graphics("test_coverage50_simulation_20221020.png")
```

## Coverage80

```{r out.width='100%', fig.align='center'}
knitr::include_graphics("test_coverage80_simulation_20221020.png")
```

## Coverage90

```{r out.width='100%', fig.align='center'}
knitr::include_graphics("test_coverage90_simulation_20221020.png")
```
