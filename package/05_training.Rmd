...
for (i in 1:20) {
                    ...
                    lmm_results[i] <- lmm_pred(train_data, train_baseline)
                    lmm_results[i]            
                  }


save(lmm_results, file = "plmlmm_simulation_lmm_dataset1_results_20220824.Rdata")
# stopCluster(myCluster)
...
for (i in 1:20) {
                    ...
                    lmm_test[i] <- lmm_pred(train_data, test_baseline)
                    lmm_test[i]            
                  }
