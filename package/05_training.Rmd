...
detectCores()
=======
>>>>>>> b1c72e4e1af505684c84bd861dd63822bf6a2f5f
myCluster <- makeCluster(20, # number of cores to use
                         type = "PSOCK") # type of cluster
registerDoParallel(myCluster)
timea <- Sys.time()
...
lmm_train <- foreach(i = 1:20, 
                  ...
                  .packages = c("plmlmm", "splines", "nlme", "tidyverse", "JMbayes")) %dopar% {
                    ...
                    lmm_results <- lmm_pred(train_data, train_baseline)
                    lmm_results           
                  }
...
lmm_test <- foreach(i = 1:20, 
                  ...
                  .packages = c("plmlmm", "splines", "nlme", "tidyverse", "JMbayes")) %dopar% {
                    ...
                    lmm_results <- lmm_pred(train_data, test_baseline)
                    lmm_results        
                  }
stopCluster(myCluster)
timeb <- Sys.time()
